...
TRAIN_DIR = 'W:/melano/newtrain'
TEST_DIR = 'W:/melano/testmany'
IMG_SIZE = 50
LR = 1e-3
...
if os.path.exists('C:/Users/Bibek/PycharmProjects/Combo/melanoma_backend{}.meta'.format(MODEL_NAME)):
